...
public class TransactionController {
	...
	public ResponseEntity<Object> newTransaction(@RequestBody @Valid Transaction newTransaction) {
	...
	public Transaction updateTransaction(@RequestBody @Valid Transaction newTransaction, @PathVariable Long transactionId) {
	...
	@ApiResponses(value = { @ApiResponse(code = 204, message = "Transaction deleted successfully"),
			...
			@ApiResponse(code = 400, message = "Field validation failed") })
	public ResponseEntity<Object> removeTransaction(@PathVariable Long transactionId) {
